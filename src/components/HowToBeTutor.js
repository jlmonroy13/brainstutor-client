      ...
      <div className="hero__tutor">
        <div className="container">
          ...
          <div className="hero__tutor-selector-container">
            <select className="hero__tutor-selector">
              <option value="as">Elige tu Universidad</option>
              <option value="c">Pascual Bravo</option>
              <option value="a">ITM(Instituto Tecnológico Metropolitano)</option>
              <option value="b">Colegio Mayor de Antioquia</option>
            </select>
            <img className="hero__tutor-selector-icon" src={require('../assets/images/check-icon.png')} />
            <span className="hero__tutor-selector-button">¡Registrate aquí!</span>
          </div>
        </div>
      </div>
